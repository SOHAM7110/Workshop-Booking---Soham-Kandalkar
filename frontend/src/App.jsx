...
const WORKSHOP_TYPES = [
  {
    ...
    terms_and_conditions:
      "Participants must bring their own laptops. Internet connection required. Basic programming knowledge preferred.",
  },

  {
    ...
    duration: 1,
    description:
      "Hands-on workshop on Scilab, the open-source alternative to MATLAB, covering basic to intermediate features.",
    terms_and_conditions:
      "Scilab must be pre-installed before the workshop. Coordinator must ensure lab facilities.",
  },
  {
    id: 3,
    ...
    duration: 1,
    description:
      "Workshop covering data manipulation and analysis using the Pandas library in Python.",
    terms_and_conditions:
      "Python and Pandas must be installed. Participants should have basic Python knowledge.",
  },
  {
    id: 4,
    name: "Introduction to OpenFOAM",
    duration: 3,
    description:
      "A multi-day workshop on the open-source CFD toolbox OpenFOAM for fluid dynamics simulations.",
    terms_and_conditions:
      "Linux environment required. Participants must complete pre-workshop reading material.",
  },

  {
    id: 5,
    name: "Basic Linux and Shell Scripting",
    duration: 1,
    description:
      "Workshop covering essential Linux commands and shell scripting for scientific computing workflows.",
    terms_and_conditions:
      "Linux or macOS preferred. Windows users must have WSL installed.",
  },
];
...
const WORKSHOPS = [
  {
    id: 1,
    workshop_type: "Python for Scientific Computing",
    workshop_type_id: 1,
    date: "2026-05-15",
    ...
    comments: [
      {
        ...
        author_id: 5,
        comment:
          "Please ensure all laptops have Anaconda installed before the session.",
        public: true,
  ...
  {
    id: 2,
    workshop_type: "Scilab Fundamentals",
    workshop_type_id: 2,
    date: "2026-06-10",
    coordinator: "Self",
    coordinator_id: 1,
  ...
  {
    id: 3,
    workshop_type: "Data Analysis with Pandas",
    workshop_type_id: 3,
    date: "2026-04-28",
    ...
    comments: [
      {
        ...
        author_id: 6,
        comment: "Dataset files will be shared 2 days before.",
        public: true,
...
// badge component for accepted or pending
const Badge = ({ status }) => {
  return (
    <span
      style={{
...
const SectionHeading = ({ children, color = C.teal }) => {
  return (
    ...
    >
      <div
        style={{ width: 4, height: 22, borderRadius: 4, background: color }}
      />
      <h3 style={{ margin: 0, fontSize: 15, fontWeight: 700, color }}>
        {children}
      </h3>
    </div>
  );
...
const InputField = ({ label, required, error, children }) => {
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      {children}
      {error && (
        <p style={{ margin: "4px 0 0", fontSize: 12, color: C.red }}>{error}</p>
      )}
    </div>
  );
};
  ...
  return (
    ...
    >
      ...
      >
        {/* logo and brand name */}
        <button
          onClick={() => setPage("workshop_types")}
          style={{
            background: "none",
            border: "none",
            cursor: "pointer",
        ...
        >
          {[
            ...
            ...(user
              ? [
                  ...(isInstructor
                    ? [{ label: "Team Stats", key: "team_stats" }]
                    : []),
                  { label: "Workshop Status", key: "workshop_status" },
                  ...(!isInstructor
                    ? [{ label: "Propose Workshop", key: "propose" }]
                    : []),
            ...
            <button
              ...
              style={{
                background:
                  page === item.key ? "rgba(255,255,255,0.15)" : "transparent",
                border: "none",
                color: page === item.key ? "#fff" : "rgba(255,255,255,0.72)",
                padding: "6px 13px",
                borderRadius: 6,
                fontSize: 13,
                fontWeight: 500,
          ...
          {user ? (
            ...
            <div style={{ display: "flex", gap: 8, marginLeft: 8 }}>
              ...
              <Btn onClick={() => setPage("register")} variant="teal">
                Register
              </Btn>
            </div>
          )}
  ...
  return (
    <Page>
      <PageHeader
        ...
        subtitle="Browse available FOSSEE workshops and view details"
        color={C.navy}
      />
      {isInstructor && (
        <div
        ...
        >
          <Btn onClick={() => setPage("add_workshop_type")} variant="primary">
            + Add Workshop Type
          </Btn>
        </div>
      )}
      <StyledTable
        ...
        rows={WORKSHOP_TYPES.map((w, i) => [
          ...
          <Td key="name" style={{ fontWeight: 600, color: C.navy }}>
            {w.name}
          </Td>,
          <Td key="dur">
            <span
          ...
          <Td key="act">
            <Btn
              ...
              size="sm"
              onClick={() => {
                setSelectedWorkshopType(w.id);
                setPage("workshop_type_details");
              }}
            >
              View Details →
            </Btn>
...
const WorkshopTypeDetailsPage = ({ workshopTypeId }) => {
  const wt =
    WORKSHOP_TYPES.find((w) => w.id === workshopTypeId) || WORKSHOP_TYPES[0];
  const rows = [
...
const ProposeWorkshopPage = () => {
  ...
  const selectedType = WORKSHOP_TYPES.find(
    (w) => w.id === Number(form.workshop_type),
  );
  ...
  const validate = () => {
    ...
    if (!form.tnc_accepted)
      e.tnc_accepted = "You must accept the terms and conditions.";
    return e;
  };
      ...
      <Page>
        <div
          style={{
            ...
            padding: "40px 32px",
            textAlign: "center",
            boxShadow: "0 4px 16px rgba(5,122,85,0.08)",
          }}
        >
          ...
          >
            Workshop Proposed Successfully!
          </h3>
          <p style={{ color: "#065f46", fontSize: 13 }}>
            Your proposal has been submitted and is pending instructor review.
          </p>
        </div>
      </Page>
    );
  ...
  return (
    <Page>
      <PageHeader
        ...
        subtitle="Fill in the details below to submit your workshop proposal"
        color={C.teal}
      />
      {/* info message */}
      <div
      ...
      >
        ...
        <span>
          Before proposing, please check the <strong>Workshop Types</strong>{" "}
          section to learn about available workshops.
        </span>
      </div>
        ...
        <div style={{ padding: "22px 24px" }}>
          ...
          >
            <select
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, workshop_type: e.target.value }))
              }
              style={inputStyle}
            >
          ...
          >
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, tnc_accepted: e.target.checked }))
              }
              ...
              <button
                onClick={() => {
                  if (!form.workshop_type) {
                    setErrors((e) => ({
                      ...e,
                      workshop_type: "Please select a workshop type first.",
                    }));
                    return;
                  }
                  setTncOpen(true);
          ...
          >
            ...
            >
              {selectedType
                ...
                : "Please select a workshop type first."}
            </div>
          </div>
        </div>
      )}
...
// co-ordinator status page---------------------------------------------------------------------------------------------------
const WorkshopStatusCoordinatorPage = ({
  user,
  setPage,
  setSelectedWorkshop,
}) => {
  ...
  if (!WORKSHOPS.length)
    return (
      <Page>
        ...
        >
          <h1 style={{ color: C.navy, fontSize: 22, margin: "0 0 8px" }}>
            Welcome, {user?.name}!
          </h1>
          <p style={{ color: "#64748b", fontSize: 14 }}>
            Your workshop information will appear here. Use{" "}
            <strong>Propose Workshop</strong> to get started.
          </p>
        </div>
      </Page>
    );
  ...
  return (
    <Page>
      <PageHeader
        title="My Workshop Status"
        subtitle="Track all your submitted and accepted workshops"
        color={C.teal}
      />
      {/* accepted workshops */}
...
const WorkshopStatusInstructorPage = ({
  ...
  const [accepted, setAccepted] = useState(
    WORKSHOPS.filter((w) => w.status && w.tnc_accepted),
  );
  const [proposed, setProposed] = useState(
    WORKSHOPS.filter((w) => !w.status && w.tnc_accepted),
  );

  //accept workshop function
  const handleAccept = (workshop) => {
    if (
      window.confirm(
        "Once accepted you cannot reject. Are you sure you want to accept this workshop?",
      )
    ) {
  ...
  return (
    <Page>
      <PageHeader
        ...
        subtitle="Manage accepted workshops and review new proposals"
        color={C.indigo}
      />
      <div style={{ marginBottom: 28 }}>
        <SectionHeading color={C.green}>Workshops Accepted</SectionHeading>
        <StyledTable
          ...
          rows={accepted.map((w) => [
            <Td key="c" style={{ color: C.blue, fontWeight: 600 }}>
              {w.coordinator}
            </Td>,
            <Td key="i">IIT Bombay</Td>,
            <Td key="n" style={{ fontWeight: 600 }}>
              {w.workshop_type}
            </Td>,
            <Td key="d">
              <span
      ...
      <StyledTable
        ...
        rows={proposed.map((w) => [
          ...
          <Td key="a">
            <Btn onClick={() => handleAccept(w)} variant="success" size="sm">
              ✓ Accept
            </Btn>
          </Td>,
        ])}
...
// workshop details with comments ----------------------------------------------------------------------------------------
const WorkshopDetailsPage = ({
  ...
  const detailRows = [
    [
      ...
      <button
        onClick={() => {
          setSelectedWorkshopType(w.workshop_type_id);
          setPage("workshop_type_details");
        }}
        style={{
          background: "none",
  ...
  return (
    <Page>
      ...
      >
        ...
        >
          <Btn onClick={postComment} variant="primary">
            Post Comment
          </Btn>
        </div>
      </div>
      ...
      {comments.map((c) => (
        ...
        >
          ...
          >
            ...
            <span style={{ fontWeight: 600, fontSize: 13, color: C.blue }}>
              {c.author}
            </span>
            {!c.public && (
              <span
...
const ViewProfilePage = ({ user, setPage }) => {
  ...
  // show profile details if has workshops
  if (hasWorkshops)
    return (
      <Page>
  ...
  return (
    <Page>
      <PageHeader
        ...
        subtitle="Explore and filter workshop records across India"
        color={C.navy}
      />
            ...
            <div style={{ padding: 14 }}>
              ...
              <InputField label="Workshop">
                <select
                  ...
                  onChange={(e) =>
                    setFilters((p) => ({ ...p, workshop_type: e.target.value }))
                  }
                  style={inputStyle}
                >
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      setFilters((p) => ({
                        ...p,
                        show_workshops: e.target.checked,
                      }))
                    }
                    style={{ accentColor: C.blue }}
                  />{" "}
              ...
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <Btn variant="teal" size="sm" style={{ flex: 1 }}>
                  ⬇ Export
                </Btn>
              </div>
            </div>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <StyledTable
            ...
            rows={WORKSHOPS.filter((w) => w.status).map((w, i) => [
              ...
              <Td key="c" style={{ fontWeight: 600, color: C.navy }}>
                {w.coordinator}
              </Td>,
              <Td key="i">IIT Bombay</Td>,
              <Td key="ins">{w.instructor || "—"}</Td>,
              <Td key="w" style={{ fontWeight: 500 }}>
                {w.workshop_type}
              </Td>,
              <Td key="d">
                <span
    ...
    >
      <div style={{ width: "100%", maxWidth: 400 }}>
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          ...
          <h2
            style={{ color: C.navy, fontWeight: 800, fontSize: 22, margin: 0 }}
          >
            Sign in to FOSSEE
          </h2>
        ...
        >
          Demo: <strong>coordinator</strong> / pass123 &nbsp;·&nbsp;{" "}
          <strong>instructor</strong> / pass123
        </p>
      </div>
    </div>
  );
    ...
    return (
      <Page>
        ...
        >
          ...
          <p style={{ color: "#1e40af", fontSize: 13, marginBottom: 20 }}>
            Check your inbox to activate your account.
          </p>
          <Btn onClick={() => setPage("login")} variant="primary" size="lg">
            Go to Login
          </Btn>
        </div>
      </Page>
  ...
  return (
    <Page>
      <PageHeader
        ...
        subtitle="Create your FOSSEE workshops account"
        color={C.blue}
      />
      <div
        style={{
    ...
    return (
      <Page>
        ...
        >
          ...
          <Btn onClick={() => setPage("workshop_types")} variant="primary">
    ...
    <Page>
      ...
      >
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <Btn onClick={() => setDone(true)} variant="success" size="lg">
            Add Workshop Type
          </Btn>
          <Btn
            onClick={() => setPage("workshop_types")}
...
export default function App() {
  ...
  // navigate function with login check
  const navigate = (p) => {
    if (
      ["workshop_status", "propose", "profile", "add_workshop_type"].includes(
        p,
      ) &&
      !user
    ) {
  ...
  const renderPage = () => {
    switch (page) {
      ...
      case "workshop_type_details":
        return (
          <WorkshopTypeDetailsPage workshopTypeId={selectedWorkshopType} />
        );
      case "propose":
        return <ProposeWorkshopPage />;
      case "workshop_status":
        return user?.role === "instructor" ? (
          <WorkshopStatusInstructorPage
            user={user}
            setPage={navigate}
            setSelectedWorkshop={setSelectedWorkshop}
          />
        ) : (
          <WorkshopStatusCoordinatorPage
            user={user}
            setPage={navigate}
            setSelectedWorkshop={setSelectedWorkshop}
          />
